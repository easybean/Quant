...
export type AssetPoolDraft = { id: string; draft_id: string; name: string; purpose: string; instruments: Array<{ instrument_draft_id: string; instrument_version: number }>; instrument_count: number; created_at: string; updated_at?: string; version: number; schema_version: string }
