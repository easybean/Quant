export type SyncStatus = { available: boolean; message?: string; target_date?: string; generated_at?: string; active_symbols?: number; endpoint_current?: number; needs_update?: number; historical_only_symbols?: number; run_available?: boolean; run_status?: string; finished_at?: string; listing_evidence?: { observed_at?: string; target_date?: string; present_endpoint_gaps: number; absent_endpoint_gaps_unknown: number }; providers?: { provider: string; status: string; counts_available?: boolean; success: number | null; failed: number | null; attempted: number | null; last_error_code?: string; finished_at?: string; resume_after?: string }[] }
